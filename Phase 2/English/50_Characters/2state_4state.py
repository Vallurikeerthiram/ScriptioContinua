...
DEFAULT_OUTPUT_PATH = Path("plain_dl_model_linewise_results.xlsx")
RANDOM_SEED = 42
PAD_TOKEN = "<PAD>"
UNK_TOKEN = "<UNK>"
PAD_LABEL = -100
...
def parse_args() -> Config:
    parser = argparse.ArgumentParser(description="Train plain DL line-wise models on 2-state and 4-state labels.")
